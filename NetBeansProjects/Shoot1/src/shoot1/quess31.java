 ...
 */
public class quess31 extends javax.swing.JFrame {
    private static GameEnvironment GE;
    ButtonGroup group = new ButtonGroup();
    
    /** Creates new form ques1 */
    public quess31(GameEnvironment GE) {
        this.GE=GE;
        group.add(jButton1);
        group.add(jButton2);
        group.add(jButton3);
    ...
    private void initComponents() {
        ...
        jTextArea7.setText("get the studentAnswer\nIF (correctAnswer = studentsAnswer)\n  dropTime = dropTime + 40;\nELSE IF\n  dropTime = dropTime + 40;\n");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quess31.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new quess31(GE).setVisible(true);
            }
        });
    } 
