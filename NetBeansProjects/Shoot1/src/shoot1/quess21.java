 ...
 */
public class quess21 extends javax.swing.JFrame {
    private static GameEnvironment GE;
    ButtonGroup group = new ButtonGroup();
    
    /** Creates new form ques1 */
    public quess21(GameEnvironment GE) {
        this.GE=GE;
        group.add(jButton1);
        group.add(jButton2);
        group.add(jButton3);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("QUESTION 2:  There is another error in this game. Pressing LEFT and RIGHT ARROWS move the gun to Right direction only.");
        ...
        jTextArea1.setText("key <-- pressed key\nMove the Gun to Right\nMove the Gun to Left");
        ...
        jTextArea3.setText("Key <-- pressed key\nIF (key = LEFT or RIGHT Arrow)\n   move the Gun to Left or Right\n\n   ");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quess21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new quess21(GE).setVisible(true);
            }
        });
    } 
