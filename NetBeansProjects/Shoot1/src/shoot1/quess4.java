 ...
 */
public class quess4 extends javax.swing.JFrame {
    private static GameEnvironment GE;
    ButtonGroup group = new ButtonGroup();
    
    /** Creates new form ques1 */
    public quess4(GameEnvironment GE) {
        this.GE=GE;
        group.add(jButton1);
        group.add(jButton2);
        group.add(jButton3);
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quess4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
