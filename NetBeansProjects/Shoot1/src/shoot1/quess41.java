 ...
 */
public class quess41 extends javax.swing.JFrame {
    private static GameEnvironment GE;
    ButtonGroup group = new ButtonGroup();
    
    /** Creates new form ques1 */
    public quess41(GameEnvironment GE) {
        this.GE=GE;
        group.add(jButton1);
        group.add(jButton2);
        group.add(jButton3);
    ...
    private void initComponents() {
        ...
        jTextArea10.setText("All of the above are correct");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quess41.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new quess41(GE).setVisible(true);
            }
        });
    } 
